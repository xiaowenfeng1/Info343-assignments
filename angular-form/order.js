...
angular.module('ProductsApp', ['ui.router'])
        ...
        return {
            ...
            link: function(scope, elem, attrs, controller) {
                controller.$validators.withinTenYears = function(modelValue) {
                    ...
                    return (modelValue <= (currentYear + 10 ));
                }
            }
        }
    })
    ...
    .controller('CheckoutController', function($scope) {
        ...
        $scope.$watch('billingSameAsShipping', function (value) {
            if(value) {
                $scope.billing = $scope.shipping;
            } else {
                $scope.billing = angular.copy($scope.billing);
            }
        });
